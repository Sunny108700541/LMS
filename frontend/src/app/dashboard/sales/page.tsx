...
import type { Lead, PageMeta } from '@/lib/types';
              ...
              {leads.map((lead) => (
                <tr key={lead.userId}>
                  ...
                  <Td>
                    ...
                    {lead.phone ? <p className="mt-0.5 text-xs text-muted">{lead.phone}</p> : null}
                  </Td>
                  <Td>
                  ...
                  <Td>
                    {lead.breFailures.length ? (
                      <span className="text-xs text-negative">{lead.breFailures.join(', ')}</span>
                    ) : (
